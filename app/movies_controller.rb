...
def can_be_instantiated_and_then_saved
  movie = Movie.new # only creates the instance does not save to database
...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.create(attributes) # create class method creates an instance and saves to the the database
end
